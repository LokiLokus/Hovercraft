				   ...
				   bool hardware_assisted, hover_hwo_type hwot)
{
	...
	switch (hwot){
		case HOVER_HWO_TYPE_SERVO:{
			hwo->pwm_freq = HOVER_HWO_SERVO_FREQ;
			hwo->pwm_min_duty_cycle = HOVER_HWO_SERVO_CYCLE_MIN;
			hwo->pwm_max_duty_cycle = HOVER_HWO_SERVO_CYCLE_MAX;
		}break;
		case HOVER_HWO_TYPE_MOTOR:{
			hwo->pwm_freq = HOVER_HWO_MOTOR_FREQ;
			hwo->pwm_min_duty_cycle = HOVER_HWO_MOTOR_CYCLE_MIN;
			hwo->pwm_max_duty_cycle = HOVER_HWO_MOTOR_CYCLE_MAX;
		}break;
	}
